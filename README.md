This project displays all the intermiediate states while a sorting algorithm sorts a given set of data. This is built using the p5.js Javascript Library.
